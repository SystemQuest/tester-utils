...
func TestInit(t *testing.T) {
	t.Run("uses seed from environment variable", func(t *testing.T) {
		// Set a specific seed
		os.Setenv("SYSTEMQUEST_RANDOM_SEED", "42")
		defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	...
	t.Run("works without seed environment variable", func(t *testing.T) {
		os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
		Init()
...
func TestRandomInt(t *testing.T) {
	os.Setenv("SYSTEMQUEST_RANDOM_SEED", "123")
	defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	Init()
...
func TestRandomWord(t *testing.T) {
	...
	t.Run("can return different values on subsequent calls", func(t *testing.T) {
		// Reset with the seed
		os.Setenv("SYSTEMQUEST_RANDOM_SEED", "77")
		Init()
...
func TestRandomWords(t *testing.T) {
	os.Setenv("SYSTEMQUEST_RANDOM_SEED", "12345")
	defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	Init()
...
func TestRandomString(t *testing.T) {
	os.Setenv("SYSTEMQUEST_RANDOM_SEED", "987")
	defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	Init()
...
func TestRandomStrings(t *testing.T) {
	os.Setenv("SYSTEMQUEST_RANDOM_SEED", "333")
	defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	Init()
...
func TestRandomElementFromArray(t *testing.T) {
	os.Setenv("SYSTEMQUEST_RANDOM_SEED", "8675309")
	defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	Init()
...
func TestRandomElementsFromArray(t *testing.T) {
	os.Setenv("SYSTEMQUEST_RANDOM_SEED", "1111")
	defer os.Unsetenv("SYSTEMQUEST_RANDOM_SEED")
	Init()
...
func TestShuffleArray(t *testing.T) {
	...
	t.Run("produces consistent results with same seed", func(t *testing.T) {
		...
		os.Setenv("SYSTEMQUEST_RANDOM_SEED", "999")
		Init()
